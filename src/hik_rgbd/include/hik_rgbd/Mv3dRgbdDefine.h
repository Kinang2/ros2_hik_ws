/***************************************************************************************************
*
* 版权信息：版权所有 (c) 2022, 杭州海康机器人股份有限公司, 保留所有权利
...
#define MV3D_RGBD_E_UPG_FILE_MISMATCH       0x80060010              // 升级固件不匹配 
#define MV3D_RGBD_E_UPG_CONFLICT            0x80060012              // 升级冲突
#define MV3D_RGBD_E_UPG_INNER_ERR           0x80060013              // 升级时相机内部出现错误
...
#define MV3D_RGBD_INT_IMAGEALIGN            "ImageAlign"            // 深度图对齐到RGB坐标系（默认值1：对齐；0：对齐），重启程序后恢复默认值
...
#define MV3D_RGBD_INT_OUTPUT_RGBD           "OutputRgbd"            // RGBD图像输出（默认值0：不输出；1：输出），重启程序后恢复默认值
...
{
    ResolutionType_1280_720     = 0x00010001,   /**< resolution 1280x720 Bining off */
    ResolutionType_640_360      = 0x00020002,   /**< resolution 640x360 Bining  2*2 */
};
